public class EmployeeBook {
    ...
    public void maxSalaryInDepartment(int department) {
        ...
        int maxSalary = 0;
        for (int i = 0; i < employees.length; i++) {
            if (employees[i] != null && employees[i].getDepartment() == department && maxSalary < employees[i].getSalary()) {
    ...
    public void minSalaryInDepartment(int department) {
        ...
        int minSalary = 999999999;
        for (int i = 0; i < employees.length; i++) {
            if (employees[i] != null && employees[i].getDepartment() == department && minSalary > employees[i].getSalary()) {
                minSalary = employees[i].getSalary();
                employee = employees[i];
